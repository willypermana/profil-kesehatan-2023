...
\begin{tabular}{rlZ{3em}Z{3em}Z{3em}Z{3em}Z{3em}Z{3em}Z{3em}Z{3em}Z{3em}}
    ...
    \midrule
	1 & Puskesmas Manggar       &    0 &    2 &  2 & 1 & 0 &  1 & 0 &  3 &  3 \\
    ...
    \midrule
	1 & RSUD Muhammad Zein      &    0 &    0 &  0 & 1 & 1 &  2 & 1 &  4 &  5 \\
    % \midrule
    % \multicolumn{2}{l}{Subjumlah RS} & 1 & 4 & 5 & 2 & 1 & 3 & 1 & 3 & 4 \\
    \midrule
    \multicolumn{2}{l}{SARANA PELAYANAN KESEHATAN LAIN}    &  0 &   0 &  0 & 0 & 0 &  0 & 0 &  0 &  0 \\
    \midrule
    \multicolumn{2}{l}{JUMLAH}                             &  5 &  14 & 19 & 5 & 8 & 13 & 3 & 19 & 22 \\
    \multicolumn{2}{l}{RASIO TERHADAP 100.000 PENDUDUK} & & & 14,77 & & & 10,11 & & & 17,10 \\
    \bottomrule
\end{tabular}%
